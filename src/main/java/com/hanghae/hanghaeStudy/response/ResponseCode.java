...
public enum ResponseCode {
    ...
    BOARD_ALL_READ_SUCCESS(HttpStatus.OK, true, "전체 게시물 조회에 성공했습니다."),
    BOARD_READ_SUCCESS(HttpStatus.OK, true, "게시물 조회에 성공했습니다."),
    BOARD_CREATE_SUCCESS(HttpStatus.CREATED, true, "게시물 등록에 성공했습니다."),
    BOARD_UPDATE_SUCCESS(HttpStatus.OK, true, "게시물 수정에 성공했습니다."),
    BOARD_DELETE_SUCCESS(HttpStatus.OK, true, "게시물 삭제에 성공했습니다.");
